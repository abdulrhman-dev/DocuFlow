...
const ar = {
  ...
  director: {
    ...
    otpRequired: "رمز الاعتماد (OTP) مطلوب",
    otpInvalid: "رمز الاعتماد غير صالح",
    otpAlreadyUsed: "تم استخدام هذا الرمز بالفعل",
    otpNotReady: "هذا الرمز لم يكتمل بعد — تأكد من رفع الصورة من التطبيق",
  },
